    ...
    class Employee
    {
        ...
        static void Main(string[] args)
        {
            ...
            IEnumerable<Details> DetailsQuery = from Details in myDetails
                                                ...
                                                select Details;
            Console.WriteLine("____all employee details-------------");
            ...
            IEnumerable<Details> DetailsQuery2 = from Details in myDetails
                                                 ...
                                                 select Details;
            Console.WriteLine("____employee details who are not in mumbai__");
            ...
            IEnumerable<Details> DetailsQuery3 = from Details in myDetails
                                                 ...
                                                 select Details;
            Console.WriteLine("____employee details whose role is AssManager__");
            ...
            IEnumerable<Details> DetailsQuery4 = from Details in myDetails
                                                 ...
                                                 select Details;
            Console.WriteLine("____employee details whose LastName starts with S___");
            ...
            Console.WriteLine("____employee details whose DOJ before 01/01/2015___");
            ...
            Console.WriteLine("____employee details whose DOB after 01/01/1990___");
            ...
            Console.WriteLine();
            Console.WriteLine("____Total number of employees :{0}", myDetails.Count);
